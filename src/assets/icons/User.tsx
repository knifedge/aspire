...
const SvgUser = (props: SvgProps) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.023 24" {...props}>
    <Path
      d="M92.817 11.547a5.6 5.6 0 0 0 4.091-1.691A5.58 5.58 0 0 0 98.6 5.773a5.581 5.581 0 0 0-1.7-4.082 5.793 5.793 0 0 0-8.181 0 5.581 5.581 0 0 0-1.7 4.082 5.58 5.58 0 0 0 1.7 4.082 5.605 5.605 0 0 0 4.098 1.692Zm0 0"
